...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/puppycoin-cli.cpp \
           src/puppycoin-tx.cpp \
           src/puppycoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/puppycoin.qrc src/qt/puppycoin_locale.qrc

TRANSLATIONS += src/qt/locale/puppycoin_bg.ts \
                src/qt/locale/puppycoin_de.ts \
                src/qt/locale/puppycoin_en.ts \
                src/qt/locale/puppycoin_es.ts \
                src/qt/locale/puppycoin_fi.ts \
                src/qt/locale/puppycoin_fr.ts \
                src/qt/locale/puppycoin_it.ts \
                src/qt/locale/puppycoin_ja.ts \
                src/qt/locale/puppycoin_pl.ts \
                src/qt/locale/puppycoin_pt.ts \
                src/qt/locale/puppycoin_ru.ts \
                src/qt/locale/puppycoin_sk.ts \
                src/qt/locale/puppycoin_sv.ts \
                src/qt/locale/puppycoin_vi.ts \
                src/qt/locale/puppycoin_zh_CN.ts \
                src/qt/locale/puppycoin_zh_TW.ts
