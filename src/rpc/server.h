...
/**
 * Puppycoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZpupSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
