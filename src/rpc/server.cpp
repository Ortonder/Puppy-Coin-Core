...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Puppycoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Puppycoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Puppycoin features */
        {"puppycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"puppycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"puppycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"puppycoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"puppycoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"puppycoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"puppycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"puppycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"puppycoin", "startmasternode", &startmasternode, true, true, false},
        {"puppycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"puppycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"puppycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"puppycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"puppycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"puppycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"puppycoin", "preparebudget", &preparebudget, true, true, false},
        {"puppycoin", "submitbudget", &submitbudget, true, true, false},
        {"puppycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"puppycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"puppycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"puppycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"puppycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"puppycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"puppycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"puppycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"puppycoin", "mnsync", &mnsync, true, true, false},
        {"puppycoin", "spork", &spork, true, true, false},
        {"puppycoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> puppycoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:24111/\n";
}
