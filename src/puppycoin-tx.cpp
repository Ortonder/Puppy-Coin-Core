...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Puppycoin Core puppycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  puppycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded puppycoin transaction") + "\n" +
                               "  puppycoin-tx [options] -create [commands]   " + _("Create hex-encoded puppycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded puppycoin transaction
