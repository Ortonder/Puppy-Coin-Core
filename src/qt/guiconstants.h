...
/* Puppycoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Puppycoin"
#define QAPP_ORG_DOMAIN "puppycoin.org"
#define QAPP_APP_NAME_DEFAULT "Puppycoin-Qt"
#define QAPP_APP_NAME_TESTNET "Puppycoin-Qt-testnet"
