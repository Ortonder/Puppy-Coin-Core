...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PUP);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePuppycoinAmount"))
        SoftSetArg("-anonymizepuppycoinamount", settings.value("nAnonymizePuppycoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in puppycoin.cpp during shotdown to also remove the window positions
