...
/** Utility functions used by the Puppycoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Puppycoin addresses in monospace font
...
// Parse "puppycoin:" URI into recipient object, return true on successful parsing
