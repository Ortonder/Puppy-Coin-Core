...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Puppycoin Core"),
     ...
     * override -datadir in the puppycoin.conf file in the default data directory
     * (to be consistent with puppycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
