...
#ifndef Puppycoin_ZPUPTRACKER_H
#define Puppycoin_ZPUPTRACKER_H
...
public:
    CzPUPTracker(std::string strWalletFile);
    ~CzPUPTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzPUPWallet* zPUPWallet = NULL);
