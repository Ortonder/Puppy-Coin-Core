...
This document provides guidelines for internationalization of the Puppycoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Puppycoin network</numerusform>
            <numerusform>%n active connections to Puppycoin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `puppycoin_en.ts` remains unchanged.
