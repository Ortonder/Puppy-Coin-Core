Contributing to Puppycoin Core
============================

The Puppycoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/puppycoin-project/puppycoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Puppycoin Core project, and is not to be
confused with overall Puppycoin Network Protocol consensus changes.

Whether a pull request is merged into Puppycoin Core rests with the project merge
...
Patches that change Puppycoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Puppycoin consensus, it must have been
...
The project leader is the release manager for each Puppycoin Core release.
