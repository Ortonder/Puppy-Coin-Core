...
from fake_stake.base_test import Puppycoin_FakeStakeTest

class zPUPwrappedSerialsTest(Puppycoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zPUPs..." % DENOM_TO_USE)
